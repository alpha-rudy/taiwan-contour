...
$(eval $(call define-foreign-region-sealand,$(ANNAPURNA_REGION),$(ANNAPURNA_BBOX_LEFT),$(ANNAPURNA_BBOX_RIGHT),$(ANNAPURNA_BBOX_BOTTOM),$(ANNAPURNA_BBOX_TOP)))
$(eval $(call define-foreign-region-outputs,$(ANNAPURNA_REGION),$(ANNAPURNA_BBOX_LEFT),$(ANNAPURNA_BBOX_RIGHT),$(ANNAPURNA_BBOX_BOTTOM),$(ANNAPURNA_BBOX_TOP)))
