...
$(eval $(call define-foreign-region-outputs,$(ALPS_PYRENEES_REGION),$(ALPS_PYRENEES_BBOX_LEFT),$(ALPS_PYRENEES_BBOX_RIGHT),$(ALPS_PYRENEES_BBOX_BOTTOM),$(ALPS_PYRENEES_BBOX_TOP)))
