...
$(eval $(call define-foreign-region-sealand,$(KASHMIR_REGION),$(KASHMIR_BBOX_LEFT),$(KASHMIR_BBOX_RIGHT),$(KASHMIR_BBOX_BOTTOM),$(KASHMIR_BBOX_TOP)))
$(eval $(call define-foreign-region-outputs,$(KASHMIR_REGION),$(KASHMIR_BBOX_LEFT),$(KASHMIR_BBOX_RIGHT),$(KASHMIR_BBOX_BOTTOM),$(KASHMIR_BBOX_TOP)))
